...
def chat_with_picture( portfolio_info,query,market_data,PictureDescription):
    # Define the Financial Expert Agent
    if not portfolio_info:
        portfolio_info = "No user info "
    financial_expert = Agent(
        role="Financial Expert",
        goal="To assist users in understanding their portfolio performance and providing insights based on the latest stock market data and Picture Description they provided.",
        backstory=(
            ...
            "Understand PictureDescription and provide insights based on it. "
    ...
    financial_task = Task(
        description=(
         f""""
         Analyze the user query to provide detailed financial insights based on their portfolio , the latest stock market trends and the picture description he provided .
